...
const Sides = () => {
  ...
  return (
    <div className={`${!finishedLoading ? 'opacity-0' : ''} duration-1000`}>
      ...
      <div className='fixed after:animate-arrow after:-rotate-180 items-center bottom-0 right-[3%] sm:flex flex-col mt-10 after:content-[""] after:bg-[#DDD] after:w-[1px] after:h-24 hidden'>
